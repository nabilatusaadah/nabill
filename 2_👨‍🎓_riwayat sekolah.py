...
st.set_page_config(
    page_title="Riwayat Sekolah | Nabila",
    page_icon="👨‍🎓",
    layout="wide"
)
...
with col1:
    st.subheader("MI YMI Wonopringgo 04")
...
with st.container():
        col1, col2, col3, col4, = st.columns(4)
        with col1:
            st.caption("*Alamat : Pegaden Tengah - Wonopringgo - Pekalongan*")
        with col2:
